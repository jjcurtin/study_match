...
**AIM 1: Build a machine learning model to predict cigarette smoking cessation.** We built a model that could predict treatment success at 4 weeks post-quit. This model used retrospective data from a previously completed comparative effectiveness trial wherein individuals who smoke were randomized to treatments, richly characterized at baseline, and followed to assess short- and long-term treatment success [@bakerEffectsNicotinePatch2016]. 
