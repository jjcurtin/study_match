...
varenicline <- retained_vars_tx |> 
  ...
  mutate(Feature = c(
    ...
    "Smoked despite relationship problems (DSM-5 Item 3)",
    "Has never tried cigars",
    "Has a depression diagnosis",
    "Does not live with another smoker",
    "Endorses smoking helps them think better (WISDM-37 Item 32)",
    "Feels tired, fatigued, or not up to par (Berlin Item 7)",
    "Has tried cigars but has never used regularly",
    "Endorses having a lot of friends or family members smoke (WISDM-37 Item 27)",
    ...
    "Bothered by feeling hopeless or discouraged (WSWS-2 Item 19)",
    "Endorses most of the people they spend time with are smokers (WISDM-37 Item 18)",
...
combo_nrt <- retained_vars_tx |> 
  ...
  mutate(Feature = c(
    ...
    "Endorses feeling like cigarattes are their best friends (WISDM-37 Item 22)",
    "Has never smoked menthol cigarettes",
    "Disagrees that there is nothing worse than feeling distressed or upset (DTS Item 5)",
    "Endorses that most of their friends and acquaintances smoke (WISDM-37 Item 30)",
    "Divorced",
    ...
    "No sleep apnea diagnosis (Berlin Item 9)",
    ...
    "Smoked knowing it was causing or worsening a health problem (DSM-5 Item 12)",
...
#| tbl-cap: Retained Interaction Features
