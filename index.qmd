...
Of the retained features, 74 were treatment interaction features. Retained features that interacted with varenicline appear in @tbl-int-varenicline. Retained features that interacted with C-NRT appear in @tbl-int-cnrt. Retained features that interacted with nicotine patch appear in @tbl-int-patch. Across these three tables, the effect direction indicates whether that feature increased or decreased abstinence when using that specific treatment (vs. the other two treatments). 

{{< embed notebooks/mak_tables.qmd#tbl-int-varenicline >}}

{{< embed notebooks/mak_tables.qmd#tbl-int-cnrt >}}

{{< embed notebooks/mak_tables.qmd#tbl-int-patch >}}
