...
21-word solution
everything posted publicly on website
preregistered aim 2 analyses 
CV as a way to help mitigate concerns about model building process
all analyses were: 1) preregistered, 2) based on CV approaches, and/or 3) following previous work from our lab and others'

### Data

info on original trial/sample/treatments & cite baker et al 2016
inclusion criteria for trial, analysis inclusion criteria
original trial procedure here?
predictors - detailed accounting of different domains, table likely helpful
outcomes
