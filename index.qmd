...
Global feature importance (mean |Shapley value|) from our model appear in @fig-shap-global, both overall (Panel A) and for treatment interaction features specifically (Panel B). The five most important feature globally were baseline carbon monoxide, identifying as White, items 2 ("Cigarettes control me.") and 30 ("Most of my friends and acquaintances smoke.") from the WISDM-37 measure [@smithDevelopmentBriefWisconsin2010], and motivation to quit. Six of the top 25 most globally important features were treatment interactions. The five most important treatment interaction features were C-NRT X living with another smoker (Response selection: "I live alone or only with a partner"), C-NRT X item 22 from the WISDM-37 measure ("Sometimes I feel like cigarettes are my best friends"), C-NRT X item 5 of the Distress Tolerance Scale ("There's nothing worse than feeling distressed or upset.") [@simonsDistressToleranceScale2005a], varenicline X living with another smoker (Response selection: "I live alone or only with a partner"), and C-NRT X smoking menthol cigarettes (Response selection: "No").

{{< embed notebooks/shap_4wk.qmd#fig-shap-global >}}

Local feature importance (i.e., the influence of features on individual observations) from our model are displayed with Sina plots in @fig-shap-local, both overall (Panel A) and for treatment interaction features specifically (Panel B). These plots help to show the directionality of the contribution each feature makes to a single prediction. Some features (e.g., motivation to quit, C-NRT X living with another smoker) have effects more narrowly in one direction, whereas other features affect predictions more equally in both directions (e.g., carbon monoxide, longest quit attempt). 

{{< embed notebooks/shap_4wk.qmd#fig-shap-local >}}
