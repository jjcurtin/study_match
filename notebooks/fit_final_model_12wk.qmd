...
switch (Sys.info()[['sysname']],
        # PC paths
        Windows = {
          path_input <- stringr::str_c("P:/chtc/", 
                                       y_col_name)
          path_models <- stringr::str_c("P:/models/", 
                                        y_col_name)},
        
        # IOS paths
        Darwin = {
          path_input <- stringr::str_c("/Volumes/chtc/", 
                                       y_col_name)
          path_models <- stringr::str_c("/Volumes/models/", 
                                        y_col_name)},
        
        # Linux paths
        Linux = {
          path_input <- stringr::str_c("~/mnt/chtc/", 
                                       y_col_name)
          path_models <- stringr::str_c("~/mnt/models/", 
                                        y_col_name)}
)
```
...
```{r }
#| label: tbl-retained-vars-wk12
#| tbl-cap: "(Supplemental) Retained features in 12-week final model"
