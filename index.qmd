...
<!-- try to break down and give digestible examples -->
...
add a sentence or two to say "so we can look at shapley values to do x, y, z..." 
why am i doing this?
1. interpretability to support implementation
2. understanding of predictors to support theory, etc
definitely add these here to provide clear justification

maybe need to show directionality of importance? SHAP more likely to give us that than glmnet coefficients. SHAP doesn't have the problem of partial effects, showing unique effects

decide if parameter estimates will also be mentioned here
...
talk to john about how to show directionality of effects
