...
<!--KW: I feel like it might be more impactful to open with the problem in traditional treatment (and maybe emphasize how big of a problem this is? For example, you could already foreshadow some of the other issues you mention below, like the cost of running clinical trials or how several treatments might have similar overall efficacy but don't necessarily work equally as well for an individual) and then introduce precision medicine and precision mental health as potential solutions to this problem (maybe as first sentence of second paragraph?).-->
...
<!--KW: I am wondering whether parts of this section would be better in the discussion. Not sure, just a thought I was having particularly as I was reading the last two paragraphs.-->
...
<!--KW: I would maybe just add citations next to your categories for any established scales that were used-->
...
I have also seen dissertations in the format where they have Chapters for different AIMs. For example you could have a "Chapter" for AIM 1 and this chapter would have its own Methods and Results section (also could have mini discussion) followed by a Chapter for AIM 3 with its own Methods and Results section.-->
