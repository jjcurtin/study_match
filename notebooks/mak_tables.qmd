...
switch (Sys.info()[['sysname']],
        # PC paths
        Windows = {
          path_data <- str_c("P:/processed_data/")
          path_models <- str_c("P:/models/pp_hybrid_wk4_outcome")},
        
        # IOS paths
        Darwin = {
          path_data <- str_c("/Volumes/processed_data/")
          path_models <- str_c("/Volumes/models/pp_hybrid_wk4_outcome")},
        
        # Linux paths
        Linux = {
          path_data <- str_c("~/mnt/processed_data/")
          path_models <- str_c("~/mnt/models/pp_hybrid_wk4_outcome")}
)
```
