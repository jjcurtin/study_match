...
<!-- CP: try to break down and give digestible examples -->
...
problem of smoking - problem of smoking cessation tx not being sufficiently effective - understandably, people have tried to predict smoking cessation - haven't done pmh tx selection but here's why i think we could do it
...
<!--KW: I would try to make this section a little easier to map onto your two aims that you use in your Methods section. A very crude example, of what I am thinking by just rearranging what you have would be: 

"The overall goal of this project was to produce a model that can serve as a decision-making tool to select among medication treatments for smoking cessation. We had two specific aims for doing this: 

1. We used machine learning analytic techniques to build a model (and evaluate) that can take advantage of many features simultaneously while maintaining generalizability to new patients.

2. We evaluated the clinical benefit of our model in these retrospective data while using resampling approaches that ensure our model offers benefit for treatment selection for new patients.

Specifically, in this project we built a machine learning model to predict treatment success 4 weeks post-quit for people who smoke who received one of three cigarette smoking cessation treatments from a previously completed comparative effectiveness trial [bakerEffectsNicotinePatch2016]. We incorporated easy-to-collect self-report data as our primary model inputs such that any resulting model will be poised for accessible, equitable clinical implementation.This model was then used to calculate probabilities of treatment success for each treatment to guide selection of the best treatment for any specific individual. Clinical benefit was evaluated by .... (maybe mention other outcomes you are looking at?)
-->
