...
<!-- consider more citations/references to how much this approach has taken off across mental health conditions. not sure if it makes sense here as a more general discussion or to be more specific later with sud/smoking (currently have it there, but could add non-sud/smoking examples here eg cancer for precision med, depression for pmh)-->
...
<!-- cite paper(s) in paper_match about roc -->
...
<!-- cite paper in paper_match folder about problems with selecting & evaluating in same sample -->
