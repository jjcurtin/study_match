...
<!-- OK just to refer to a detailed table! -->
...
<!-- all designed to optimize the bias-variance trade-off. difficult to determine a priori where we need to be along the continuum, so we consider multiple configurations. anchor in BVTO -->
