...
The names of all retained features and their parameter estimates from the final 4-week model appear in @tbl-retained-vars-4wk. Retained features for the 4-week model are discussed in detail in the main manuscript. 

{{< embed notebooks/fit_final_model_4wk.qmd#tbl-retained-vars-4wk >}} 
...
{{< embed notebooks/fit_final_model_12wk.qmd#tbl-retained-vars-12wk >}} 

Our final 26-week model fit with the full dataset retained retained 107 features (@tbl-retained-vars-26wk). Of these, 45 were treatment interaction features. Like above, variability among folds led to the final model having slightly fewer than 50 retained interaction features. 
